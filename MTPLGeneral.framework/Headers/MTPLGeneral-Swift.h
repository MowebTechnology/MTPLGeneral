...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MTPLGeneral",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11MTPLGeneral23AppNavigationController")
...
@interface AppNavigationController (SWIFT_EXTENSION(MTPLGeneral)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)gestureRecognizer SWIFT_WARN_UNUSED_RESULT;
@end


@interface AppNavigationController (SWIFT_EXTENSION(MTPLGeneral)) <UINavigationControllerDelegate>
